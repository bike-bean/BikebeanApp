...
class WarningNumber private constructor(
    ...
    constructor(
            sms: Sms,
            warningNumberGetter: () -> String
    ) : this(sms, warningNumberGetter(), State.STATUS.CONFIRMED)

    constructor(sms: Sms) : this(sms, "", State.STATUS.UNSET)

    constructor(sms: Sms, warningNumber: String) : this(sms, warningNumber, State.STATUS.UNSET)
